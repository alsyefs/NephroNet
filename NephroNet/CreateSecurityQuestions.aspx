<%@ Page Title="Create your security questions and answers" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateSecurityQuestions.aspx.cs" Inherits="NephroNet.CreateSecurityQuestions" %>
