<%@ Page Title="Approve Topics" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="ApproveJoinTopics.aspx.cs" Inherits="NephroNet.Accounts.Patient.ApproveJoinTopics" %>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <asp:GridView ID="grdTopics" runat="server" Width="100%" HorizontalAlign="Center" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" PageSize="20" AllowPaging="True" OnPageIndexChanging="grdTopics_PageIndexChanging">
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="~/Accounts/Patient/ReviewJoinTopic.aspx?id={0}" SortExpression="id" Text="Review" />
                    </Columns>
